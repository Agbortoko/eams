...
<ul class="mt-10">
    ...
    <li class="group rounded-lg group-[.active] mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "batch/index.php") || strpos($hayStack, "batch/add.php") ? "sidebar_item-active" : "" ?>">
