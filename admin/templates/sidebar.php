...
<ul class="mt-10">
    <li class="group rounded-lg group-[.active] mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "admin/index.php") ? "sidebar_item-active" : "" ?>">
        <a href="<?= baseUrl('admin/') ?>" class="flex items-center gap-3 text-white text-lg py-2 px-4">
    ...
    <li class="group rounded-lg group-[.active] mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "batch/index.php") || strpos($hayStack, "batch/add.php") || strpos($hayStack, "batch/edit.php") || strpos($hayStack, "batch/batch_students.php") ? "sidebar_item-active" : "" ?>">
        <a href="<?= baseUrl('admin/batch/index.php') ?>" class="flex items-center gap-3 text-white text-lg py-2 px-4">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-5 h-5 group-[.active] fill-black dark:fill-white" viewBox="0 0 16 16">
    ...
    <li class="group rounded-lg group-[.active] mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "admin/students.php") || strpos($hayStack, "admin/student/edit.php") ? "sidebar_item-active" : "" ?>">
        <a href="<?= baseUrl('admin/students.php') ?>" class="flex items-center gap-3 text-white text-lg py-2 px-4">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-5 h-5 group-[.active] fill-black dark:fill-white" viewBox="0 0 16 16">
    ...
    <li class="group rounded-lg group-[.active] mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "admin/approve.php") || strpos($hayStack, "admin/approve_student.php") ? "sidebar_item-active" : "" ?>">
        <a href="<?= baseUrl('admin/approve.php') ?>" class="flex items-center gap-3 text-white text-lg py-2 px-4">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-5 h-5 group-[.active] fill-black dark:fill-white" viewBox="0 0 16 16">
    ...
    <li class="group rounded-lg mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "admin/profile.php") ? "sidebar_item-active" : "" ?>">
        <a href="<?= baseUrl('admin/profile.php') ?>" class="flex items-center gap-3 text-white text-lg py-2 px-4 ">
    ...
    <li class="group rounded-lg mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "admin/reports.php") ? "sidebar_item-active" : "" ?>">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 group-[.active] fill-black dark:fill-white" viewBox="0 0 16 16">
            ...
            <span class="group-[.active] text-black dark:text-white">Reports</span>
        </a>
    </li>
    ...
    <li class="group rounded-lg mb-5 hover:bg-neutral-300 dark:hover:bg-gray-600 <?= strpos($hayStack, "admin/settings.php") ? "sidebar_item-active" : "" ?>">
        <a href="<?= baseUrl('admin/settings.php') ?>" class="flex items-center gap-3 text-white text-lg py-2 px-4 ">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 group-[.active] fill-black dark:fill-white" viewBox="0 0 16 16">
