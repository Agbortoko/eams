...
<ul class="mt-10">
    <li class="group rounded-lg group-[.active] mb-5 hover:bg-gray-600 <?= $currentFile == 'index.php' ? "sidebar_item-active" : "" ?>">
    ...
    <li class="group rounded-lg mb-5 hover:bg-gray-600 <?= $currentFile == 'settings.php' ? "sidebar_item-active" : "" ?>">
