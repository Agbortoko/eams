...
<?php require_once __DIR__ . "/templates/header.php"; ?>
    ...
    <main class="py-10 px-2 min-h-screen bg-slate-100 dark:bg-gray-900 bg-pattern">
            ...
            <section class="container mx-auto px-5 min-h-[300px] md:min-h-[500px] flex items-center justify-center ">
                <h1 class="dark:text-white text-center font-semibold"><span class="text-primary uppercase font-bold block mb-5 text-6xl md:text-7xl">Eschosys Internship</span><span class="block text-4xl md:text-6xl">Attendance Management System<span></h1>
            </section>
